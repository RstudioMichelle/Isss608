...
## **1.4 Create Network Objects Using tidygraph**
...
## **1.4.4 Review the Output of tidygraph’s Graph Object**

```{r}
GAStech_graph
```

## **1.4.5  Review the Output of tidygraph’s Graph Object**
...
## **1.5 Plot Static Network Graphs with ggraph Package**
...
This section uses [*theme_graph()*](https://ggraph.data-imaginist.com/reference/theme_graph.html) to remove the x and y axes.
...
In the step below, [*facet_edges()*](https://ggraph.data-imaginist.com/reference/facet_edges.html) is used.
...
In the step below, [*facet_nodes()*](https://ggraph.data-imaginist.com/reference/facet_nodes.html) is used.
...
## **1.8.2 Plot the first interactive network graph**
